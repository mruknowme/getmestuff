...
<div class="text flex vertical w8 m-auto" data-2000="top: -100px;" data-2200="top: 190px;" data-2700="opacity: 1;">
    <div data-2300="opacity: 0;" data-2500="opacity: 1;" class="w45 self-start">
        <h3>Almos There</h3>
        <p>After all the hard work that has been put into the project and organization of the strategy, we are finally ready to launch GetMeStuff worldwide.</p>
    </div>
    <img class="main-image" src="{{ asset('images/ex.png') }}">
    <div data-2500="opacity: 0;" data-2700="opacity: 1;" class="w45 self-end">
        <h3>Steady Growth</h3>
        <p>With hundreds of users from all over the world joining every day and publishing their wishes, we take care of each and every one to make their lives just a bit happier.</p>
    </div>
</div>