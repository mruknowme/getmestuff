...
i18nDefaults.create.title = '<h4 class="">'+i18nDefaults.create.title+'</h4>';
i18nDefaults.edit.title = '<h4 class="">'+i18nDefaults.edit.title+'</h4>';
i18nDefaults.remove.title = '<h4 class="">'+i18nDefaults.remove.title+'</h4>';
...
$.extend( true, $.fn.dataTable.Editor.classes, {
	"header": {
		"wrapper": "DTE_Header panel-heading"
	},
	"body": {
		"wrapper": "DTE_Body panel-body"
	},
	"footer": {
		"wrapper": "DTE_Footer panel-footer"
	},
	"form": {
		"tag": "form-horizontal",
...
DataTable.Editor.display.bootstrap = $.extend( true, {}, DataTable.Editor.models.displayController, {
	...
	"open": function ( dte, append, callback ) {
		...
		var content = self._dom.content.find('div.panel-body');
		content.children().detach();
		content.append( append );

		$('div.panel-heading', append).prepend( self._dom.close );
