    ...
    <nav class="navbar navbar-default navbar-static-top m-b-0">
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right pull-right">
                <li>
                    <a target="_blank" href="/home" title="Open site home page in a new tab" class="waves-effect waves-light">
                    ...
                    <ul class="dropdown-menu mega-dropdown-menu animated bounceInDown">
                        ...
                        <li class="col-sm-3">
                            <ul>
                                ...
                                <li><a href="/admin/wishes/settings">Wishes Settings</a></li>
                            </ul>
                        </li>
                        <li class="col-sm-3">
                            <ul>
                                ...
                                <li><a href="/admin/tickets/create">New Ticket</a></li>
                            </ul>
                        </li>
                        <li class="col-sm-3">
                            <ul>
